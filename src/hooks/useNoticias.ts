...
export function useNoticias(initialPageSize = 5) {
  ...
  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect -- busca de dados é uso válido de efeito: https://react.dev/learn/you-might-not-need-an-effect#fetching-data
    void fetchPage();
  }, [fetchPage]);
